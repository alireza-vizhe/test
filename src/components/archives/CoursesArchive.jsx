...
const CoursesArchive = () => {
  ...
  return (
    <section>
      <Helmet>
            <title>{`همه دوره ها | علم آموزان `}</title>
          </Helmet>
      {!loading ? (<div className="container my-4">
        ...
        <div className="col-md-6 sec-two-texts text-left">
            <h4><span className="text-white">همه</span><a href="https://elmamouzan.ir/all-courses" className="text-dark">دوره های علم آموزان</a></h4>
        ...
        />
      </div>) : (<div className="cliploader"><ClipLoader
          color="#333"
          loading={loading}
          size={150}
          aria-label="Loading Spinner"
