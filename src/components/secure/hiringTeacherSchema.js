...
export const hiringTeacher = Yup.object().shape({
  email: Yup.string()
  ...
  message: Yup.string()
    .required("باید درباره خود به ما شرح دهید")
    .min(10, "متن پیام شما حداقل باید 10 کاراکتر باشد")
    .max(1000, "متن پیام شما حداکثر باید 1000 کاراکتر باشد"),
  phone: Yup.string()
    .required("شماره موبایل شما برای ارتباط با شما الزامی می باشد"),
    experience: Yup.string().required("حوزه کاری شما الزامی می باشد")
});
